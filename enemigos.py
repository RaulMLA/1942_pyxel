...
class Enemigo:
    def __init__(self, x: int, y:int):
        ...
        self.sprites_bank = [
            ...
            # Superbombardero (completo) -> Dirección 'up' ([32:34])
            (0, 0, 143, 63, 48),
            (0, 64, 143, 63, 48),

            # Superbombardero (semicompleto) -> Dirección 'up' ([34:36])
            (0, 128, 143, 63, 48),
            (0, 192, 143, 63, 48),

            # Superbombardero (destruido) -> Dirección 'up' ([36:37])
            (0, 128, 94, 63, 48),
        ]
        self.sprites = []
        self.index = 0
    ...
    def animation(self):
        ...
        if self.tipo == 'regular' and self.direction in ['down', 'downleft', 'downright']:
            ...
            if self.lives > config.ENEMIGOS4_LIVES / 2:
